...
export interface IUserRepository {
  ...
  findByGoogleId(googleId: string): Promise<(User & { _id: Types.ObjectId; id: string }) | null>;
  create(userData: Partial<User>): Promise<User & { _id: Types.ObjectId; id: string }>;
  update(id: string | Types.ObjectId, userData: Partial<User>): Promise<(User & { _id: Types.ObjectId; id: string }) | null>;
